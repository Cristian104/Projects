    ...
    fetch('/api/stats')
        ...
        .then(data => {
            if (document.getElementById('cpu-text')) {
                ...
                document.getElementById('ram-text').innerText = data.ram_used + ' GB';
                document.getElementById('ram-sub').innerText = '/ ' + data.ram_total + ' GB';
                document.getElementById('ram-bar').style.width = data.ram_pct + '%';
                document.getElementById('disk-text').innerText = data.disk_used + ' GB';
                document.getElementById('disk-sub').innerText = '/ ' + data.disk_total + ' GB';
